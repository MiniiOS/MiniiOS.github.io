...
2. 选择你需要安装的应用，点击「一键安装」
3. 弹出提示后点击「允许」，等待描述文件下载
4. 前往「设置 - 通用 - VPN与设备管理」信任证书
5. 返回桌面等待应用安装完成

## ⚠️ 重要注意事项
1. **仅支持 Safari 浏览器**，其他浏览器无法触发安装协议
2. 应用均为已签名版本，重启手机后可能需要重新签名安装
...
| MiraPlay | 1.4 | 38MB+ | com.gendago.catpaw | - |
| 酷狗概念版 | 2.5.5 | 83MB+ | com.kugou.kgyouth | - |
| XMusic | 1.2 | 4MB+ | org.galio.XMusic | - |
| 动漫共和国 | 1.0.0 | 38MB+ | com.example.dongmangongheguo | - |
